...
export function initSettingsModal() {
    ...
    const settingsBtn = document.getElementById('settingsBtn'); // Bouton des paramètres dans le header
...
/**
 * Créer la structure HTML du Modal Paramètres dans le DOM
 */
            ...
            <div style="background: var(--card-bg, #111b24); border: 1px solid var(--card-border, rgba(16, 185, 129, 0.2)); width: 480px; max-width: 90%; border-radius: 14px; box-shadow: 0 20px 25px -5px rgba(0,0,0,0.5); overflow: hidden;">
                ...
                <div style="padding: 16px 20px; border-bottom: 1px solid rgba(255,255,255,0.06); display: flex; justify-content: space-between; align-items: center;">
                    <div style="display: flex; align-items: center; gap: 10px;">
                        ...
                        <h3 style="font-size: 13px; font-weight: 700; color: #fff; margin: 0;">Paramètres du Compte</h3>
                    </div>
                ...
                <div style="padding: 20px; display: flex; flex-direction: column; gap: 16px;">
                    ...
                    <div>
                        ...
                        <select id="settingsLangSelect" style="width: 100%; background: rgba(0,0,0,0.3); border: 1px solid rgba(255,255,255,0.1); color: #fff; padding: 10px; border-radius: 8px; font-size: 12px; outline: none;">
                    ...
                    <div>
                        ...
                        <select id="settingsThemeSelect" style="width: 100%; background: rgba(0,0,0,0.3); border: 1px solid rgba(255,255,255,0.1); color: #fff; padding: 10px; border-radius: 8px; font-size: 12px; outline: none;">
                    ...
                    <div>
                        ...
                        <input type="password" id="settingsNewPassword" placeholder="Nouveau mot de passe" style="width: 100%; background: rgba(0,0,0,0.3); border: 1px solid rgba(255,255,255,0.1); color: #fff; padding: 10px; border-radius: 8px; font-size: 12px; outline: none; margin-bottom: 8px; box-sizing: border-box;">
                        <input type="password" id="settingsConfirmPassword" placeholder="Confirmer le nouveau mot de passe" style="width: 100%; background: rgba(0,0,0,0.3); border: 1px solid rgba(255,255,255,0.1); color: #fff; padding: 10px; border-radius: 8px; font-size: 12px; outline: none; box-sizing: border-box;">
                    </div>
...
/**
 * Charger les paramètres actuels de l'utilisateur depuis user_profiles
 */
async function loadUserSettings() {
    try {
        ...
        if (data) {
            ...
            if (data.theme) document.getElementById('settingsThemeSelect').value = data.theme;
        }
    } catch (err) {
...
/**
 * Enregistrer les modifications (Langue, Thème, Mot de passe)
 */
window.saveUserSettings = async function() {
    ...
    try {
        ...
        // 1. Mettre à jour user_profiles (Langue et Thème)
        ...
        // Appliquer le thème directement si besoin
